...
% \begin{figure}[h]
%     \centering
%     \includegraphics[height=150pt]{task1/self-attn.jpg}
%     \caption{Self-Attention Block}
% \end{figure}

\begin{minipage}[t]{.5\textwidth}
    \centering
    \adjustbox{valign=t}{\includegraphics[scale=0.41]{task1/self-attn.jpg}}
    \\Self Attention Block
\end{minipage}
\begin{minipage}[t]{.46\textwidth}
    \centering
    \adjustbox{valign=t}{\includegraphics[scale=0.26]{task1/cbam.jpg}}
\end{minipage}
...
\begin{minipage}[t]{.47\textwidth}
    \centering
    \adjustbox{valign=t}{\includegraphics[scale=0.22]{task1/top1.jpg}}
    256x256 images Avg GMS: 3.85666
\end{minipage}
\begin{minipage}[t]{.47\textwidth}
    \centering
    \adjustbox{valign=t}{\includegraphics[scale=0.22]{task1/top2.jpg}}
